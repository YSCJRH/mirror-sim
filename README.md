...
The planned evidence note path is
...
- The planned Phase 60 Selected-World Review Artifact Integrity Evidence path is `docs/plans/phase-60-selected-world-artifact-integrity-evidence-2026-05-23.md`.
